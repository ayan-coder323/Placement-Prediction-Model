...
FILE_NAME = base_dir / "dataset" / "final_preprocess_M2.csv"
output_folder = base_dir / "outputs" / "Regularization_ridg_laso_elastic_outputs"
...
comparison.to_csv(
   base_dir / "dataset" / "regularisation_model_comparison_M2.csv",
   index=False
)
...
coefficient_table.to_csv(
   base_dir / "dataset" / "regularisation_coefficients_M2.csv",
   index=False
)
...
lasso_features.to_csv(
   base_dir / "dataset" / "lasso_feature_selection_M2.csv",
   index=False
)
